...
const CAUSES = [
  {
    icon: Sparkle,
    title: 'Acné después de los 25',
    description:
      'El acné adulto no funciona igual que el de la adolescencia — suele tener causas distintas (hormonales, estrés, productos inadecuados) y requiere un enfoque diferente.',
  },
  {
    icon: ScanFace,
    title: 'Cicatrices',
    description:
      'Las marcas y cicatrices que deja el acné activo necesitan un diagnóstico de su tipo y profundidad antes de elegir cualquier tratamiento para mejorarlas.',
  },
  {
    icon: Search,
    title: '¿Por qué es difícil tratarlo solo?',
    description:
      'Productos de venta libre no distinguen el tipo de acné ni su causa — sin un diagnóstico dermatológico, es común probar varios productos sin resolver la causa real.',
  },
]
...
const TREATMENTS = [
  {
    ...
    description: 'Manejo tópico y/o oral prescrito según el tipo y la gravedad de tu acné.',
  },
  {
    icon: Droplets,
    title: 'Peelings químicos',
    description: 'Renovación celular para ayudar a mejorar textura y marcas superficiales.',
  },
  {
    icon: Zap,
    title: 'Micropunción',
    description: 'Estimulación de la piel orientada a mejorar cicatrices de acné.',
  },
  {
    icon: ShieldCheck,
    title: 'Limpieza facial profesional',
    description: 'Extracción y cuidado profesional como parte del plan, no como sustituto del tratamiento médico.',
  },
]
...
const EXPECTATIONS = [
  {
    ...
    description:
      'La Dra. Haide evalúa tu piel, identifica el tipo de acné y sus posibles causas antes de proponer cualquier tratamiento.',
  },
  {
    icon: Stethoscope,
    step: '2',
  ...
  },
  {
    ...
    description:
      'El acné y sus cicatrices suelen requerir varias sesiones y ajustes en el tiempo. Los resultados pueden variar según cada paciente.',
  },
]
          ...
          <div className="section-container">
            <div className="mx-auto max-w-2xl text-center">
              <span className="inline-flex items-center rounded-full bg-primary-100 px-4 py-1.5 text-sm font-semibold text-primary-700">
                Entendiendo el acné adulto
              </span>
              <h2 className="section-title mt-6">No todo el acné es igual</h2>
              <p className="section-subtitle mx-auto">
                Antes de tratar el acné o sus cicatrices es necesario entender qué
                lo provoca — por eso un diagnóstico dermatológico hace la
                diferencia.
              </p>
            </div>
          ...
          <div className="section-container grid items-center gap-12 md:grid-cols-5">
            ...
            <div className="md:col-span-3">
              ...
              <p className="section-subtitle">
                ...
                enfermedades de la piel, la Dra. Haide aborda el acné con un
        ...
        <section className="py-20 md:py-28">
          <div className="section-container">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="section-subtitle mx-auto">
                El acné y sus secuelas son una condición que se maneja, no se
                "cura" de la noche a la mañana — así se ve el proceso en consulta.
              </p>
            </div>
